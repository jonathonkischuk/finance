...
RISK_FREE_RATE = 0.05
# considering monthly returns (want to calculate annual returns)
MONTHS_IN_YEAR = 12
...
class CAPM:
    ...
    def regression(self):
        ...
        # we are after annual returns (this is why we multiply by 12)
...
if __name__ == '__main__':
    capm = CAPM(['MSFT', '^GSPC'], '2017-01-01', '2025-07-31')
    capm.initialize()
    capm.calculate_beta()
    capm.regression()
