...
from stock_price_monte_carlo import NUM_OF_SIMULATIONS
...
def display_monte_carlo_simulation(x, r0, kappa, theta, sigma, T=1):
    dt = T / float(NUM_OF_POINTS)
    result = []
...
if __name__ == '__main__':
    ...
    display_monte_carlo_simulation(1000, 0.1, 0.3, 0.1, 0.03)
